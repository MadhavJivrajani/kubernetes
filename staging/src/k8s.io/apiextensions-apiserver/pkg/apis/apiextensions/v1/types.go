...
type CustomeResourceDefinitionFeatureGates struct {
	...
	// +optional
	Component *string `json:"component,omitempty" protobuf:"bytes,2,opt,name=component"`
}
...
type CustomResourceDefinitionFeatureGate struct {
	...
	Enabled bool `json:"enabled" protobuf:"varint,2,opt,name=enabled"`
	// default is the default enablement state for the feature.
	Default bool `json:"default" protobuf:"varint,3,opt,name=default"`
	...
	PreRelease string `json:"preRelease" protobuf:"bytes,4,opt,name=preRelease"`
	// fieldPaths defines the fields in JSON path format that this feature gate
	// aims to guard.
	FieldPaths []string `json:"fieldPaths" protobuf:"bytes,5,rep,name=fieldPaths"`
}
