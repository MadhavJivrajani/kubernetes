...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CustomResourceDefinitionFeatureGates)(nil), (*apiextensions.CustomResourceDefinitionFeatureGates)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_CustomResourceDefinitionFeatureGates_To_apiextensions_CustomResourceDefinitionFeatureGates(a.(*CustomResourceDefinitionFeatureGates), b.(*apiextensions.CustomResourceDefinitionFeatureGates), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*apiextensions.CustomResourceDefinitionFeatureGates)(nil), (*CustomResourceDefinitionFeatureGates)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_apiextensions_CustomResourceDefinitionFeatureGates_To_v1_CustomResourceDefinitionFeatureGates(a.(*apiextensions.CustomResourceDefinitionFeatureGates), b.(*CustomResourceDefinitionFeatureGates), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_CustomResourceDefinitionFeatureGates_To_apiextensions_CustomResourceDefinitionFeatureGates(in *CustomResourceDefinitionFeatureGates, out *apiextensions.CustomResourceDefinitionFeatureGates, s conversion.Scope) error {
...
// Convert_v1_CustomResourceDefinitionFeatureGates_To_apiextensions_CustomResourceDefinitionFeatureGates is an autogenerated conversion function.
func Convert_v1_CustomResourceDefinitionFeatureGates_To_apiextensions_CustomResourceDefinitionFeatureGates(in *CustomResourceDefinitionFeatureGates, out *apiextensions.CustomResourceDefinitionFeatureGates, s conversion.Scope) error {
	return autoConvert_v1_CustomResourceDefinitionFeatureGates_To_apiextensions_CustomResourceDefinitionFeatureGates(in, out, s)
}

func autoConvert_apiextensions_CustomResourceDefinitionFeatureGates_To_v1_CustomResourceDefinitionFeatureGates(in *apiextensions.CustomResourceDefinitionFeatureGates, out *CustomResourceDefinitionFeatureGates, s conversion.Scope) error {
	out.FeatureGates = *(*[]CustomResourceDefinitionFeatureGate)(unsafe.Pointer(&in.FeatureGates))
	out.Component = (*string)(unsafe.Pointer(in.Component))
	return nil
}

// Convert_apiextensions_CustomResourceDefinitionFeatureGates_To_v1_CustomResourceDefinitionFeatureGates is an autogenerated conversion function.
func Convert_apiextensions_CustomResourceDefinitionFeatureGates_To_v1_CustomResourceDefinitionFeatureGates(in *apiextensions.CustomResourceDefinitionFeatureGates, out *CustomResourceDefinitionFeatureGates, s conversion.Scope) error {
	return autoConvert_apiextensions_CustomResourceDefinitionFeatureGates_To_v1_CustomResourceDefinitionFeatureGates(in, out, s)
}
