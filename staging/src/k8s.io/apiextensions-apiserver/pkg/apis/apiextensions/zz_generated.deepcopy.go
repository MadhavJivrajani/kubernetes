...
func (in *CustomResourceDefinitionSpec) DeepCopyInto(out *CustomResourceDefinitionSpec) {
	*out = *in
	...
	if in.CustomFeatureGates != nil {
		...
		*out = new(CustomeResourceDefinitionFeatureGates)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomeResourceDefinitionFeatureGates) DeepCopyInto(out *CustomeResourceDefinitionFeatureGates) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomeResourceDefinitionFeatureGates.
func (in *CustomeResourceDefinitionFeatureGates) DeepCopy() *CustomeResourceDefinitionFeatureGates {
	if in == nil {
		return nil
	}
	out := new(CustomeResourceDefinitionFeatureGates)
